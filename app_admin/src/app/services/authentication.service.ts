...
export class AuthenticationService {
  ...
  // Login method that leverages the login method in TravelDataService 
  ...
  public login(user: User, passwd: string): void {
    this.TravelDataService.login(user, passwd)
      .subscribe({
        next: (value: any) => {
          if (value) {
            console.log(value);
  ...
  } // Register method that leverages the register method in // TravelDataService
  ...
  public register(user: User, passwd: string): void {
    this.TravelDataService.register(user, passwd)
      .subscribe({
        next: (value: any) => {
          if (value) {
            console.log(value);
